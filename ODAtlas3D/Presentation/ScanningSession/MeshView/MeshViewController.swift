...
open class MeshViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    @IBOutlet weak var renderGrayscaleButton: UIButton!
    @IBOutlet weak var renderTextureButton: UIButton!
    ...
    @IBAction func setTexturedRender(_ sender: UIButton) {
        renderer.setRenderingMode(.textured)
        colorizeMesh()
    }
    
    @IBAction func setGrayscaleRender(_ sender: UIButton) {
